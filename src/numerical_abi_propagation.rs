...
mod tests {
    ...
    fn test_op(index: usize, inputs: Vec<i32>, outputs: Vec<i32>) -> OpInfo {
        OpInfo {
            ...
            ops: 0.0,
            estimated_bytes: 0.0,
            reported_estimated_bytes: Some(0.0),
            ...
            reported_intensity_ops_per_byte: Some(0.0),
            ...
            reported_bottleneck_compute_us: Some(0.0),
            bottleneck_memory_us: 0.0,
            reported_bottleneck_memory_us: Some(0.0),
            bottleneck_packing_us: 0.0,
            reported_bottleneck_packing_us: Some(0.0),
            bottleneck_break_us: 0.0,
            reported_bottleneck_break_us: Some(0.0),
            bottleneck_fallback_us: 0.0,
            reported_bottleneck_fallback_us: Some(0.0),
            bottleneck_total_us: 0.0,
            reported_bottleneck_total_us: Some(0.0),
