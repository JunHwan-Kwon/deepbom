...
```bash
npx -y deepbom@1.101.0 integrate codex
npx -y deepbom@1.101.0 integrate codex --apply
npx -y deepbom@1.101.0 integrate claude-code
npx -y deepbom@1.101.0 integrate claude-code --apply
```
...
`deepbom-1.101.0.mcpb` asset from the corresponding GitHub Release. The bundle
