...
8. Registry download is opt-in. Prefer a verified exact-version installation; use `npx -y deepbom@1.99.0` only after network and installation permission is clear.
