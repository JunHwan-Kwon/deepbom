...
for (const [condition, message] of [
  ...
  [!/(pricing|subscription|purchase|member exports|research access|medical ai access)/i.test(html), "public shell contains no pricing or commercial access-tier language"],
