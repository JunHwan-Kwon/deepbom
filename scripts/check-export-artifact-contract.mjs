...
expectEqual(engineeringReportArtifacts.metricCoverage.schema, "deepbom.metric_coverage_manifest.v1.54", "Engineering Report should emit field-level metric coverage schema v1.54 with canonical Artifact IR ownership and the existing format-specific static/runtime decision bindings.");
