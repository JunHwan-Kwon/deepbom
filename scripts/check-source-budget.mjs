...
const handwrittenRuntimeBudgetKiB = Number(process.env.HANDWRITTEN_RUNTIME_SOURCE_BUDGET_KIB || process.env.SOURCE_BUDGET_KIB || 12576);
const generatedRuntimeDataBudgetKiB = Number(process.env.GENERATED_RUNTIME_DATA_BUDGET_KIB || 1728);
// Optional numerical IR modules, public schema/guide and numeric/capture regression tests.
const docsSourceBudgetKiB = Number(process.env.DOCS_SOURCE_BUDGET_KIB || 656);
const verificationSourceBudgetKiB = Number(process.env.VERIFICATION_SOURCE_BUDGET_KIB || 3744);
