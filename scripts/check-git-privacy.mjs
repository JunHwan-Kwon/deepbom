...
const sanctionedModelFixtures = new Map([
  ...
  ["corpus/external-review/fixtures/coreml-affine-attributes.mlpackage/Data/com.deepbom.fixture/model.mlmodel", "scripts/fixtures/generate-external-review-coreml.py"],
  ["corpus/external-review/fixtures/coreml-affine-missing-axis.mlmodel", "scripts/fixtures/generate-external-review-coreml.py"],
  ...
  ["corpus/external-review/fixtures/gguf-f16.gguf", "scripts/fixtures/generate-external-review-gguf.mjs"],
  ["corpus/external-review/fixtures/gguf-q4-0.gguf", "scripts/fixtures/generate-external-review-gguf.mjs"],
  ["corpus/external-review/fixtures/gguf-q8-0.gguf", "scripts/fixtures/generate-external-review-gguf.mjs"],
  ["corpus/external-review/fixtures/onnx-invalid-external-range/model.onnx", "scripts/fixtures/generate-external-review-onnx.mjs"],
  ["corpus/external-review/fixtures/quant-scale-risk.tflite", "scripts/fixtures/generate-quant-risk-tflite.py"],
  ["corpus/external-review/fixtures/quant-scale-risk-1000x.tflite", "scripts/fixtures/derive-quant-scale-diff-fixture.mjs"],
  ["corpus/external-review/fixtures/space-to-batch-stale-shapes.tflite", "scripts/fixtures/generate-external-review-tflite.py"],
  ["corpus/external-review/fixtures/transpose-conv-dynamic.tflite", "scripts/fixtures/generate-external-review-tflite.py"],
  ["corpus/external-review/fixtures/transpose-conv-same-cropped.tflite", "scripts/fixtures/generate-external-review-tflite.py"],
  ["corpus/external-review/fixtures/transpose-conv-valid.tflite", "scripts/fixtures/generate-external-review-tflite.py"],
