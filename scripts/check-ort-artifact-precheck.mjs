...
expectEqual(boolEvidence.source_condition_inventory?.source_rule_count, 938, "Protected evidence must bind the complete pinned EP/operator rule inventory.");
...
expectEqual(boolEvidence.portability_frontier.all_ep_source_match_op_count, 0, "The eight-profile common source intersection must remain empty when XNNPACK has no Add registration.");
