...
const SMOKE = [
  ...
  "scripts/check-external-review-ledger.mjs",
  "scripts/check-external-review-defect-gate.mjs",
  ...
  "scripts/check-integration-kit.mjs",
  "scripts/check-measurement-oracles.mjs",
  "scripts/check-huggingface-space-contract.mjs",
  "scripts/check-public-adoption-boundary.mjs",
  ...
  ...(existsSync("worker/usage-metrics.js") ? ["scripts/check-usage-metrics.mjs"] : []),
...
const FORMATS = [
  ...
  "scripts/check-external-review-coreml-correctness.mjs",
  "scripts/check-external-review-gguf-correctness.mjs",
  "scripts/check-external-review-onnx-correctness.mjs",
  "scripts/check-external-review-boundary-corpus.mjs",
  "scripts/check-semantic-artifact-diff.mjs",
...
const RELEASE = [
  ...
  "scripts/check-numerical-ir-browser.mjs",
  "scripts/check-chatgpt-mcp.mjs",
