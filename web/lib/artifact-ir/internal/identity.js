import { exactInteger, normalizeSha256 } from "./shared.js";
...
export function artifactIdentity(analysis, artifact, format) {
  ...
  const size = exactInteger(artifact.size ?? artifact.byte_length ?? analysis.file_size_bytes ?? analysis.file_size);
  return {
