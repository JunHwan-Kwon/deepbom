...
const FORMAT_SCOPES = Object.freeze({
  ...
  executorch: Object.freeze({
    ...
    assessed: "ET12 execution plans, ordered instructions, EValue contracts, 209 source-pinned portable operator signatures, matching KernelCall input/output direction and nominal tensor-contraction MACs, serialized delegate IDs and compile specs, segment conservation, AOT planned buffers, and FT01 named external tensor data",
    runtimeBoundary: "Custom or signature-mismatched KernelCall rows and delegate-internal graphs remain unbound; backend availability, runtime allocation, kernels, physical transfers, and latency require native ExecuTorch evidence",
    nextProof: "Bind the exact ExecuTorch runtime and backend build, resolve any required PTD tensor data, then import executed delegate and memory evidence",
    ...
    dashboardCopy: "Observed ET12/FT01 contracts are separated from opaque backend blobs and unobserved runtime behavior.",
